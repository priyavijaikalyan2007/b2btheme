...
| [hovercard](#hovercard) | `components/hovercard/hovercard.css` | `components/hovercard/hovercard.js` |
| [inlinetoolbar](#inlinetoolbar) | `components/inlinetoolbar/inlinetoolbar.css` | `components/inlinetoolbar/inlinetoolbar.js` |
| [latexeditor](#latexeditor) | `components/latexeditor/latexeditor.css` | `components/latexeditor/latexeditor.js` |
| [layerlayout](#layerlayout) | `components/layerlayout/layerlayout.css` | `components/layerlayout/layerlayout.js` |
| [layoutpicker](#layoutpicker) | `components/layoutpicker/layoutpicker.css` | `components/layoutpicker/layoutpicker.js` |
