...
| Component | Description | Factory | Docs |
|-----------|-------------|---------|------|
| codeeditor | Bootstrap 5-themed code editor wrapping CodeMirror 6 with syntax highlighting, toolbar, diagnostics, and graceful tex... | `createCodeEditor()` | [README](docs/components/codeeditor/README.md) |
